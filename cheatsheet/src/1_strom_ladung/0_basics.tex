\subsection*{Basics}
    \begin{center}
        \begin{empheq}{align*}
            \overrightarrow{B} &\quad \text{Magnetische Induktion} & T = \frac{W b}{m^2} = \frac{V \cdot s}{m^2} = \frac{kg}{A \cdot s^2} \\
            C &\quad \text{Kapazität} & F = \frac{C}{V} = \frac{A \cdot s}{V} = \frac{A^2 \cdot s^4}{kg \cdot m^2}
        \end{empheq}
    \end{center}
    \begin{itemize}
